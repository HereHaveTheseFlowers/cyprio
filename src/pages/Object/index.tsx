...
export default function Object() {
    ...
    if (store.getState().objects && store.getState().objects[id]) {
        ...
        const handleAddToCart = () => {
            let cart: string[] = store.getState().cart;
            if(!cart) cart = [currentObject.name];
            else cart.push(currentObject.name)
            store.set("cart", cart)
            ...
            return (
                <>
                    ...
                    <section className="object">
                        <img style={{height: "500px", width: "200px"}} src={currentObject.mainImage} alt={currentObject.altText} className="object__image object__image_loaded" draggable="false"  />
                        <div className="object__card">
                            <div className="object__info">
                                <div className="object__header">
                            ...
                            { (!isTablet || isMobile) &&
                                <div className="object__links">
                                    ...
                                    <span className="object__url"><Button className="object__nav-button" onClick={handleAddToCart}>КУПИТЬ</Button></span>
