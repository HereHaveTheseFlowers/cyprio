...
export function ObjectCard(props: ObjectCardProps) {
    ...
    if(props.mode === 'cart') {
        return (
            <div className="object-card" onClick={navigateObject} data-category={category} style={{ width: "180px" }}>
        ...
        if(!props.previewImage || imageLoading) {
            ...
            return (
                <div className="object-card" onClick={navigateObject} data-category={category} style={{position: "relative", marginBottom: "50px"}}>
                    <img className="object-card__image object-card__image_loaded" src={props.previewImage} alt={props.altText} draggable="false" width={objectImageSize} height={objectImageSize} />
                    <div className="object-card__info">
                        <span className="object-card__brand">{props.brand}</span>
                        <span className="object-card__name">{props.name}</span>
                ...
                <div style={{ position: "absolute", bottom: "-50px"}}>{props.name}</div>
                </div>
            )
        }
    } else if(props) {
