  ...
  return (
    <div className={`filters-tab${stickyClass}`}>
        ...
        <span className="filters-tab__filters">
            ...
            <Button onClick={applyFilter} className='filters-tab__filter'>Футболки</Button>
            <Button onClick={applyFilter} className='filters-tab__filter'>Толстовки</Button>
            { !isMobile && 
              <>
                <Button onClick={applyFilter} className='filters-tab__filter'>Рубашки</Button>
                <Button onClick={applyFilter} className='filters-tab__filter'>Жилеты</Button>
              </>
            }
        </span>
        { isMobile && 
